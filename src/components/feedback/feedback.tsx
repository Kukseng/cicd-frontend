...
const AnimatedGhost = () => {
  return (
    <div className="relative scale-75 sm:scale-100">
      ...
      >
        <div
          className="relative w-36 h-36 grid grid-cols-14 grid-rows-14 gap-0"
          style={{
            gridTemplateAreas: `
        ...
        >
          ...
          {[
            ...
            <div
              key={id}
              className={`${
                type === "flicker0" ? "animate-pulse" : "animate-ping"
              }`}
              style={{
                gridArea: id,
                backgroundColor: "red",
          ...
          <div className="absolute top-8 left-3 w-10 h-12">
            ...
            <div
              className="absolute w-5 h-5 bg-blue-500 top-5 left-0 z-10 animate-pulse"
          ...
          <div className="absolute top-8 right-8 w-10 h-12">
            ...
            <div className="absolute w-10 h-8 bg-white transform translate-y-2"></div>
            <div
              className="absolute w-5 h-5 bg-blue-500 top-5 right-0 z-10 animate-pulse"
              style={{ animationDuration: "3s" }}
            ></div>
          </div>
        </div>
